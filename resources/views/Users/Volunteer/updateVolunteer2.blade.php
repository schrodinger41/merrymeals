			...
			role="dialog">
				<div class="modal-dialog">
					<div class="modal-content" style="background-color: var(--accent-color); color: rgb(31, 31, 31);">
						...
						<form action="{{ route('volunteer#saveProfile', $userData->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="was-validated">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter age" name="age" value="{{ $userData->age }}" required />
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="volunteer_vaccination" class="d-flex form-label" style="font-weight: 900">Volunteer Vaccination Status:</label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="volunteer_vaccination" value="0" {{ $volunteerData->volunteer_vaccination == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="volunteer_vaccination" value="1" {{ $volunteerData->volunteer_vaccination == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter volunteer duration" name="volunteer_duration" value="{{ $volunteerData->volunteer_duration }}" required />
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                ...
                <div class="d-flex">
                    <div class="card-body mt-3 m-2" style="border: 2px var(--primary-color) solid">
                        ...
                        <div class="row pb-3 pt-3">
                            <div class="col-4" style="font-weight: 900">VACCINATION STATUS:</div>
                            <div class="col-8"> 
                              @if($volunteerData->volunteer_vaccination == 0)
                                  Yes
                              @else
                                  No
                              @endif</div>
                        ...
                        <div class="row pb-3 pt-3">
                          ...
                          <div class="col-8">{{ implode(', ', json_decode($volunteerData->volunteer_available, true) ?? []) }}</div>
                        </div>
                        <hr>
                        <div class="row pb-3 pt-3">
