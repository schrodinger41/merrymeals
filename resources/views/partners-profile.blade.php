                            ...
                            <div class="modal-body">
                                ...
                                <div class="was-validated">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control"
                                        placeholder="Enter the name of your business or company" name=""
                                        required="true" />
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this
                                        field.</div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control"
                                        placeholder="Enter the duration of your partnership" name=""
                                        required="true" />
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this
                                        field.</div>
                ...
                <div class="d-flex">
                    <div class="card-body text-left d-flex" style="height: 284px">
                        ...
                        <div class="card-body mt-5">
                            ...
                            <hr>
                            <button type="button" class="btn btn-outline-dark text-center" data-bs-toggle="modal"
